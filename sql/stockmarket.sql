...
CREATE
DATABASE /*!32312 IF NOT EXISTS*/`stockmarket` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert into `stock_info`(`stockId`, `stockCode`, `stockName`)
values (1, 1001, ''stock1001'');
...
insert into `user_info`(`userId`, `username`, `password`, `cash`)
values (1996, ''root'', ''lsc115500'', ''1000 '');
